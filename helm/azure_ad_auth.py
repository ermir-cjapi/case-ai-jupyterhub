...
def get_graph_access_token_on_behalf_of(user_assertion: str) -> str:
    """
    ...
    """
    print("================================================================================")
    print("🔁 OBO FLOW: Exchanging user assertion for Microsoft Graph token...")
    ...
    data = {
        ...
        # Incoming user assertion (for JupyterHub app) - usually ID token
